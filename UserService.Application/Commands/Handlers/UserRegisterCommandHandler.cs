...
public class UserRegisterCommandHandler : IRequestHandler<UserRegisterCommand, ResponseModel>
{
    ...
    public UserRegisterCommandHandler(IUnitOfWork repository, IMapper mapper, IFirebaseStorageRepository firebaseStorageRepository, IFirebaseAuthenticationRepository firebaseAuthenticationRepository)
    {
    ...
    public async Task<ResponseModel> Handle(UserRegisterCommand? registerModel, CancellationToken cancellationToken)
    {
         ...
         if (registerModel.RegisterModel.AvatarFile != null)
         {
             ...
             try
             {
                 ...
                 uploadedUrl = await _firebaseStorageRepository.UploadImageAsync(
                     fileName, registerModel.RegisterModel.AvatarFile, 
         ...
         var newUser = new User
         {
             ...
             Role = BitConverter.GetBytes(256)
         };
