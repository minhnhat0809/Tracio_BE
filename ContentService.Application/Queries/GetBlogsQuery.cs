...
public class GetBlogsQuery(int userRequestId, int? userId, int? categoryId, sbyte? status, string sortBy, bool ascending, int pageSize, int pageNumber) : IRequest<ResponseDto>
{
